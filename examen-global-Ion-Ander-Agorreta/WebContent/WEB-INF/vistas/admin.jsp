...
<table class="table">
	<thead>
		<tr>
			...
			<th><a class="btn btn-primary" href="#" data-toggle="modal" data-target="#añadir" id="sfa">Añadir</a></th>
		</tr>
	</thead>
	<tbody>
		<c:forEach items="${libros}" var="libros">
			<tr>
				...
				<td><a class="btn btn-primary "
					href="#" data-toggle="modal" data-target="#modificar" onclick="editar(this,event)">Editar</a> <a
					class="btn btn-danger BorrarLibroSencillo" href="BorrarServlet">Borrar</a>
				</td>
			</tr>
		</c:forEach>
	</tbody>
			...
			<div class="modal" id="añadir">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="AñadirServlet" method="post"
								class="form-signin">
								...
								<input type="number" id="img" name="img" class="form-control"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="ModificarServlet" method="post"
								class="form-signin" id="formMod">
								<h1 class="h3 mb-3 font-weight-normal">Modifique los datos</h1>
								
								<div>
									<input type="text" id="titulom"
										name="titulom" class="form-control" placeholder="" autofocus>
								</div>


								<div>
									<input type="text" id="autorm"
										name="autorm" class="form-control" placeholder="" autofocus>
								</div>


								<div>
									<input type="number" id="isbnm"
										name="isbnm" class="form-control" placeholder="" autofocus>
								</div>
