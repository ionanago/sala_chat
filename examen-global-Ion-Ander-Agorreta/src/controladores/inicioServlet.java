...
public class inicioServlet extends HttpServlet {
	...
	private static final String VISTAS_INDEX_JSP = "/WEB-INF/vistas/inicio.jsp";
    
    

	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		final RequestDispatcher requestDispatcherIndex = request.getRequestDispatcher(VISTAS_INDEX_JSP);
